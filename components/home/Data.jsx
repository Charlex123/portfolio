...
const Data = () => {
  ...
  const originalText = "Charles Muoka";
  ...
  return (
    <div className="home__data">
      ...
      <a href="mailto:charlesmuoka1@gmail.com" className="button button--flex">
        ...
        >
          <path
            d="M20 4H4C2.9 4 2 4.9 2 6V18C2 19.1 2.9 20 4 20H20C21.1 20 22 19.1 22 18V6C22 4.9 21.1 4 20 4ZM20 6L12 13L4 6H20ZM4 18V8L12 15L20 8V18H4Z"
